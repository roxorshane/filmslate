  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-6 pt-10 pb-20">
        ...
        <p className="text-xl text-gray-500 mb-6" style={{ fontFamily: 'Georgia, serif' }}>
          {film.description}
        </p>
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">{longDate(article.publishDate)}</p>
          </div>
        </div>
        ...
        <div className="border border-gray-200 p-6 mb-10">
          <p className="text-xs uppercase tracking-widest text-gray-400 mb-4">Film details</p>
          <div className="space-y-3">
            <MetaRow icon={<Film size={14} />} label="Director" value={film.director} />
            <MetaRow icon={<Calendar size={14} />} label="Year" value={String(film.releaseYear)} />
            <MetaRow icon={<Clock size={14} />} label="Runtime" value={`${film.runtime} min`} />
            {film.awards.length > 0 && (
              <div className="flex gap-3 pt-3 border-t border-gray-100">
                <span className="flex-shrink-0 mt-0.5 text-gray-400"><Award size={14} /></span>
        ...
        <div className="border border-gray-900 p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mt-4">Part of FilmSlate's rotating 30-day library</p>
        </div>
