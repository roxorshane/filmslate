...
import { formatPublishDate } from '@/helpers';
...
function getCritiqueArticle(film: FilmData): CritiqueArticle {
  return {
    filmId: film.id,
...
function getAllCritiqueArticles(): CritiqueArticle[] {
  return ALL_FILMS
    .map(getCritiqueArticle)
    .sort((a, b) => b.publishDate.localeCompare(a.publishDate));
}

export { getCritiqueArticle, getAllCritiqueArticles, formatPublishDate };
export default { getCritiqueArticle, getAllCritiqueArticles, formatPublishDate };
